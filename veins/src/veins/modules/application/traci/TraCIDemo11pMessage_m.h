...
class VEINS_API TraCIDemo11pMessage : public ::veins::BaseFrame1609_4
{
  ...
  public:
    ...
    virtual double getMessageInitTime() const;
    virtual void setMessageInitTime(double MessageInitTime);
    virtual int getRequestDeadline() const;
    virtual void setRequestDeadline(int RequestDeadline);
    virtual int getServiceTime() const;
    virtual void setServiceTime(int ServiceTime);
    virtual bool getRequester() const;
    virtual void setRequester(bool Requester);
