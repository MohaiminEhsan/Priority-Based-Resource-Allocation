...
class Registry
{
    ...
    std::map<int, std::map<int, std::tuple<int, double, int, int, int, int, float, float, double, int, bool>>> msgRegistry;
    ...
    std::map<int, std::tuple< int, int, int, int, int, int, int, int, int,int, int>> appRegistry;
    std::map<int, std::tuple< int, int, int, int, int, int, int, int, int,int, int>> appRegistryRL;
    std::map<int, std::tuple< int, int, int, int, int, int, int, int, int,int,double, int >> appRegistryFZ;

    std::map<int, std::tuple<float, int, int, int>> FuzzyRequestRegistry;
